...
<html lang="">
    <head>
        ...
        <title>New Password</title>
            ...
            <body>
    <section style="width: 80%;margin: auto;height:auto; padding-bottom:20px;box-shadow: 0 0 10px #76A140;color: rgb(255, 255, 255); border-radius: 5px;">
        <div id="head_1" style="background: #76A140; height: 80px;">
         <h2 style="margin: 0;padding: 25px;color: white;background: #76A140;font-family:sans-serif;font-weight: bold;">PrimedPoll</h2><br><br>
        </div>
        ...
        <div id="box" style="width: 95%; margin: auto;"><br>
                    ...
                    <h5 style="text-align:right;">Cryptoprofusion</h5>
