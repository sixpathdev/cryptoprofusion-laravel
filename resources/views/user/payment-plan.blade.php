    ...
    <div class="row">
        ...
        <div class="col-lg-9 ml-sm-auto col-xl-10 pl-3 pr-5 px-xl-5 pt-1">
            <div class="row pt-md-4">
                <div class="col-12">
                    <h5 class="text-muted">Select Payment Plan</h5>
                </div>
            </div>
                    ...
                    <div class="card" style="width: 16em;">
                        <div class="card-body" style="padding: 0px;">
                            <div class="title text-center py-1" style="background: white;">
                                <span class="text-dark font-weight-bold h4">{{ Ucwords($plan->name) }}</span>
                            </div>
                            <div>
                                <img src="/img/bitcoin-image.png" class="img-fluid" />
                            </div>
                            <div class="text-center py-2" style="background: white;">
                                <a href="/user/plan/{{$plan->name}}" class="font-weight-bold"
                                    style="color: #76A140;font-size:18px;">SELECT</a>
                            </div>
                        </div>
                    </div>
                </div>
